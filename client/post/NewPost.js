...
class NewPost extends Component {
 ...
 photo: '',
  ...
  clickPost = () => {
    ...
    create({
  userId: jwt.user._id},{t: jwt.token},this.postData)
  ...
  render() {
    ...
    return (<div className={classes.root}>
      ...
      <CardActions>
        <Button color="primary" variant="raised" disabled={this.state.text === ''} onClick={this.clickPost} className={classes.submit}>Partager</Button>
      </CardActions>
    </Card>
  </div>)
  }
