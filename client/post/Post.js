    ...
    return (
      <Card className={classes.card}>
        ...
        <CardHeader
            ...
            avatar={
            <Avatar  style=
            {{backgroundColor:auth.isAuthenticated().user.avatarColor?
             auth.isAuthenticated().user.avatarColor:'orange'}} >
          
          {auth.isAuthenticated().user.name? 
          auth.isAuthenticated().user.name.at(0).toUpperCase() :''}
           </Avatar>
            }
            ...
            subheader={(new Date(this.props.post.created)
